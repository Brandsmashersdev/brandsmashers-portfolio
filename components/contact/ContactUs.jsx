    ...
    <div className={styles.container} id="contact-us">
      ...
      <div className={styles.right}>
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <p>How we can help<span className={styles.required}>*</span></p>
          ...
          <p>What skills are you looking for?<span className={styles.required}>*</span></p>
          <select
            name="skills"
          ...
          <p>How did you hear about Brandsmashers?<span className={styles.required}>*</span></p>
          <select
            name="referral"
            className={styles.select}
